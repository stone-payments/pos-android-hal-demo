 ...
 * [Postcondition] message and a button to proceed with the execution.
 *
...
class PostconditionTestRule :
    ...
    override fun apply(base: Statement?, description: Description): Statement {
        ...
        val postcondition = description.getAnnotation(Postcondition::class.java)

        if (!HALConfig.runningOnEmulator && postcondition != null) {
            ...
            runOnUiThread {
                activity.apply {
                    ...
                    findViewById<TextView>(R.id.textView_message).text =
                        String.format(getString(R.string.test_message_format_after), postcondition.text)
